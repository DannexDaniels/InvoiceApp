...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InvoiceDbQueries query = new InvoiceDbQueries(this);

        rvBills = (RecyclerView) findViewById(R.id.rvBills);

        rvBills.setHasFixedSize(true);
        rvBills.setLayoutManager(new LinearLayoutManager(this));
        rvBills.setAdapter(new CustomerBillAdapter(query.retrieveBill(),getApplicationContext()));
